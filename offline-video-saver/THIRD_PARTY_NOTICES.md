...
Runtime components are installed independently by the container build:
...
binary bundle is responsible for preserving notices and satisfying the exact
license obligations of the versions they distribute.
