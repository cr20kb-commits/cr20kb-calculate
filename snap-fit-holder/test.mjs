...
const d35=C.resolve({D:35,fit:35*(22/22.03-1),L:41,wall:2.5,width:30,holeD:5});
...
const cases=[
  ...
  {D:35,fit:35*(22/22.03-1),width:30,L:41,wall:2.5,holeD:5,quality:48,arcChord:.18},
...
console.log(`Snap-Fit v1.2 PASS: base triangles=${base.triangles}, D35 pitch=${d35.holeSpacing.toFixed(1)} mm, flange=${d35.flangeWidth.toFixed(1)} mm`);
